export const Data={
    ...
    Intro: [{
        ...
        ActualData: `var fruits = ["Banana","Oragne","Apple","Mango"]; fruits.splice(0,1);`,
        ...
        ActualData: `var txt = "ABCDEFGHIGHIKLMNOPQRSTUVWXYZ var length = txt.length var text1 = "Hello World"; var text2 = text1.toUpperCase();`,
